package com.hk47bot.rotp_wr.client.render.particle;
...
public class ReverseAirStreamParticle extends SpriteTexturedParticle {
    private final float yRot;
    private final float xRot;

    protected ReverseAirStreamParticle(ClientWorld world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
    ...
    public static class Factory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType type, ClientWorld world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ReverseAirStreamParticle particle = new ReverseAirStreamParticle(world, x, y, z, xSpeed, ySpeed, zSpeed);
